...
def build_train_program(conf, data_gen_fn):
    ...
    with fluid.program_guard(train_prog, init_prog):
        ...
        adam_optimizer = fluid.optimizer.Adam(learning_rate=0.0001)
...
if __name__ == '__main__':
    ...
    print "read raw data"
    reader = csv.reader(open('./debug.tsv'), delimiter='\t')
    ...
    q1 = array_normalize(q1, pad_to_len=20)
    q2 = array_normalize(q2, pad_to_len=20)
